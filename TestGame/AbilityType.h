...
inline const char* GetAbilityName(AbilityType type)
{
    ...
    case AbilityType::ShieldOfFaith:   return "Shield of Faith";
    case AbilityType::HolyBolt:        return "Holy Bolt";
    case AbilityType::HammerThrow:     return "Hammer Throw";
    case AbilityType::LayOnHands:      return "Lay on Hands";
...
inline const char* GetAbilityDesc(AbilityType type)
{
    ...
    case AbilityType::ShieldOfFaith:   return "+damage and a\nsmall heal";
    case AbilityType::HolyBolt:        return "Ranged bolt of\nholy light";
    case AbilityType::HammerThrow:     return "Thrown hammer\nstuns on hit";
    case AbilityType::LayOnHands:      return "Restore a large\nchunk of health";
    case AbilityType::DivineStorm:     return "Holy nova around\nyou, all MP";
    case AbilityType::AvengingWrath:   return "+dmg, lifesteal &\nheal, all MP";
